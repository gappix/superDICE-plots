...
baseexp = PBLs3exp$v0x103$OPTIM$ed57$ssp2 #common part
...
tatm_plot <- RICEx.plot.lineplot(
  EXPdata   = list(
    ...
    ,"Coop Pop"           = baseexp$coop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_TATM_ty
    ,"Coop Negishi"       = baseexp$coop_negishi$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_TATM_ty
    ,"Non Coop"           = baseexp$noncoop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_TATM_ty
...
damages_plot <- RICEx.plot.lineplot(
  EXPdata   = list(
    ...
    ,"Coop Pop"     = baseexp$coop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_VARIABLE_WORLDagg_ntyTOty("DAMAGES")
    ,"Coop Negishi" = baseexp$coop_negishi$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_VARIABLE_WORLDagg_ntyTOty("DAMAGES")
    ,"Non Coop"     = baseexp$noncoop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_VARIABLE_WORLDagg_ntyTOty("DAMAGES")
  )
...
emi_plot <- RICEx.plot.lineplot(
  EXPdata   = list(
    ...
    ,"Coop Pop"     = baseexp$coop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_worldEMItot_ty
    ,"Coop Negishi" = baseexp$coop_negishi$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_worldEMItot_ty
    ,"Non Coop"     = baseexp$noncoop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_worldEMItot_ty
  )
...
forc_plot <- RICEx.plot.lineplot(
  EXPdata   = list(
    ...
    ,"Coop Pop"           = baseexp$coop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_VARIABLE_ty("FORC")
    ,"Coop Negishi"       = baseexp$coop_negishi$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_VARIABLE_ty("FORC")
    ,"Non Coop"           = baseexp$noncoop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging$CBA__pb18mup28$get_VARIABLE_ty("FORC")
