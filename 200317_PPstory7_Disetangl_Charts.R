...
PPstory7 = list()
PPstory7 = experiments_load_as_list(PPstory7,"PPstory7")



# shortcuts
PP7 = PPstory7$v1x00$OPTIM$ed57
...
#----  World EMI  -  SSP2 BHM SR   -  # DISGamma    -------------------------
...
#----  World EMI  -  SSP2 BHM SR  -  # DISGamma + DICE trends   ---------------------------------
