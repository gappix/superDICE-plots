...
# ADD NTY Variables
#
add_nty_variable_to_table <- function(my_table, S3data_class,  variable_name_nty){
  
  new_df = S3data_class$get_Variable_nty(variable_name_nty)
...
# ADD TY Variables
#
add_ty_variable_to_table <- function(my_table, S3data_class,  variable_name_ty){
  
  new_df = S3data_class$get_Variable_ty(variable_name_ty)
