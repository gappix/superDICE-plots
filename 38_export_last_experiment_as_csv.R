...
# NTY
temp_table_nty = latest_experiment_load_as_table_nty() %>% 
...
output_table_nty = temp_table_nty %>% select(-c("experiment_tag",
                                                ...
                                                "policy"))
# TY 
temp_table_ty = latest_experiment_load_as_table_ty() %>% mutate(exp_id = paste0(experiment_tag,"_",
                                                                                        regional_aggregation, "_",
                                                                                        ssp, "_",
                                                                                        cooperation, "_",
                                                                                        climate_module, "_",
...
## PARS
output_table_pars =  latest_experiment_load_as_table_pars() %>% mutate(exp_id = paste0(experiment_tag,"_",
                                                                                       regional_aggregation, "_",
                                                                                       ssp, "_",
                                                                                       cooperation, "_",
                                                                                       climate_module, "_",
