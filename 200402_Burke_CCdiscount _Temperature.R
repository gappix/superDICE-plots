...
BurkeDDLTV = list()
BurkeDDLTV = experiments_load_as_list(BurkeDDLTV,"BurkeDDLTV")



# shortcuts
BKD        = BurkeDDLTV$v1x00$SIMUL$ed57$ssp5$noncoop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging
BKDnoncoop = BurkeDDLTV$v1x00$OPTIM$ed57$ssp5$noncoop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging
BKDcoop    = BurkeDDLTV$v1x00$OPTIM$ed57$ssp5$coop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_disentangled$savings_fixed_converging
BKDcooppop = BurkeDDLTV$v1x00$OPTIM$ed57$ssp2$coop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging


#ssp2
BKDssp2_noncoop = BurkeDDLTV$v1x00$OPTIM$ed57$ssp2$noncoop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging
BKDssp2_coop    = BurkeDDLTV$v1x00$OPTIM$ed57$ssp2$coop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_disentangled$savings_fixed_converging
BKDssp2_cooppop = BurkeDDLTV$v1x00$OPTIM$ed57$ssp2$coop_pop$mcEDct4$climate_WITCHco2$damages_BURKEnSR$welfare_DICE$savings_fixed_converging
...
# Original Burke values
Burke_dfrac_original_nty = BKD$BAUdam__XXJ$get_PARAMETER_nty("damfrac_burkesim")


#============================================================#
####          _______ BAU TESTS  ________                 ####
#============================================================#
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
      ...
      "4-5 ºC | 0.15" = BKD$BAUdam__XXJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
     ,"4-5 ºC | 0.25" = BKD$BAUdam__XXK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
     ,"4-5 ºC | 0.40" = BKD$BAUdam__XXX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
     ,"4-5 ºC | 0.50" = BKD$BAUdam__XXY$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
     ,"4-5 ºC | 0.75" = BKD$BAUdam__XXW$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
     ,"4-5 ºC | 1.00" = BKD$BAUdam__XXZ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    , "burke"    = Burke_dfrac_original_nty %>% filter(n==myreg, year <= 2120)
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 ºC | 0.15" = BKD$BAUdam__XYJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-5 ºC | 0.25" = BKD$BAUdam__XYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-5 ºC | 0.40" = BKD$BAUdam__XYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-5 ºC | 0.50" = BKD$BAUdam__XYY$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-5 ºC | 0.75" = BKD$BAUdam__XYW$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-5 ºC | 1.00" = BKD$BAUdam__XYZ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-7 ºC | 0.15" = BKD$BAUdam__XZJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-7 ºC | 0.25" = BKD$BAUdam__XZK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-7 ºC | 0.40" = BKD$BAUdam__XZX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-7 ºC | 0.50" = BKD$BAUdam__XZY$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-7 ºC | 0.75" = BKD$BAUdam__XZW$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-7 ºC | 1.00" = BKD$BAUdam__XZZ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "5-6 ºC | 0.15" = BKD$BAUdam__YYJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-6 ºC | 0.25" = BKD$BAUdam__YYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-6 ºC | 0.40" = BKD$BAUdam__YYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-6 ºC | 0.50" = BKD$BAUdam__YYY$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-6 ºC | 0.75" = BKD$BAUdam__YYW$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-6 ºC | 1.00" = BKD$BAUdam__YYZ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "5-7 ºC | 0.15" = BKD$BAUdam__YZJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-7 ºC | 0.25" = BKD$BAUdam__YZK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-7 ºC | 0.40" = BKD$BAUdam__YZX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-7 ºC | 0.50" = BKD$BAUdam__YZY$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-7 ºC | 0.75" = BKD$BAUdam__YZW$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-7 ºC | 1.00" = BKD$BAUdam__YZZ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    , "burke"    = Burke_dfrac_original_nty %>% filter(n==myreg, year <= 2150)
...
p1 <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "4-5 ºC | 0.40" = BKD$BAUdam__XXX$get_VARIABLE_ty("DDLTV") 
 
     
,   "4-6 ºC | 0.40" = BKD$BAUdam__XYX$get_VARIABLE_ty("DDLTV")     
,   "5-6 ºC | 0.40" = BKD$BAUdam__YYX$get_VARIABLE_ty("DDLTV") 
 
 
,   "4-7 ºC | 0.40" = BKD$BAUdam__XZX$get_VARIABLE_ty("DDLTV")   
,   "5-7 ºC | 0.40" = BKD$BAUdam__YZX$get_VARIABLE_ty("DDLTV") 
...
p2 <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "4-5 ºC | 0.40" = BKD$BAUdam__XXX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
,   "4-6 ºC | 0.40" = BKD$BAUdam__XYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)      
,   "4-7 ºC | 0.40" = BKD$BAUdam__XZX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...

{
  ...
  p1 <- RICEx.plot.lineplot(
    ...
    "4-5 ºC | 0.15" = BKD$BAUdam__XXK$get_VARIABLE_ty("DDLTV") 
,   "4-6 ºC | 0.15" = BKD$BAUdam__XYK$get_VARIABLE_ty("DDLTV")   
,   "4-7 ºC | 0.15" = BKD$BAUdam__XZK$get_VARIABLE_ty("DDLTV") 

,   "5-6 ºC | 0.15" = BKD$BAUdam__YYK$get_VARIABLE_ty("DDLTV") 
,   "5-7 ºC | 0.15" = BKD$BAUdam__YZK$get_VARIABLE_ty("DDLTV") 
  ...
  p2 <- RICEx.plot.lineplot(
    ...
    "4-5 ºC | 0.15" = BKD$BAUdam__XXK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  

,   "4-6 ºC | 0.15" = BKD$BAUdam__XYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)      
,   "4-7 ºC | 0.15" = BKD$BAUdam__XZK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 

,   "5-6 ºC | 0.15" = BKD$BAUdam__YYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
,   "5-7 ºC | 0.15" = BKD$BAUdam__YZK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.15" = BKD$BAUdam__XXJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"4-6 °C | 0.15" = BKD$BAUdam__XYJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"5-6 °C | 0.15" = BKD$BAUdam__YYJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  

    ,"4-5 °C | 0.25" = BKD$BAUdam__XXK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-6 °C | 0.25" = BKD$BAUdam__XYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"5-6 °C | 0.25" = BKD$BAUdam__YYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    ,"4-5 °C | 0.40" = BKD$BAUdam__XXX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    ,"4-6 °C | 0.40" = BKD$BAUdam__XYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)   
    ,"5-6 °C | 0.40" = BKD$BAUdam__YYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    ,"burke"  = Burke_dfrac_original_nty %>% filter(n==myreg, year <= 2140)
  )
  
  ,title  = paste0("Damages (%GDPssp) for ", myreg, " region — CBA NONcoop SSP5")
  ,yLabel = "Damages [%GDPssp]"
  ,legend = "Scenarios"
  ,categories = 4
...
#============================================================#
####          _______ NONCOOP TESTS  ________             ####
#============================================================#
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.40" = BKDnoncoop$CBA__XXX$get_world_EMIffi_ty  
    ,"4-6 °C | 0.40" = BKDnoncoop$CBA__XYX$get_world_EMIffi_ty      
    ,"4-7 °C | 0.40" = BKDnoncoop$CBA__XZX$get_world_EMIffi_ty 
     
    ,"5-6 °C | 0.40" = BKDnoncoop$CBA__YYX$get_world_EMIffi_ty  
    ,"5-7 °C | 0.40" = BKDnoncoop$CBA__YZX$get_world_EMIffi_ty  
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.40" = BKDnoncoop$CBA__XXX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"4-6 °C | 0.40" = BKDnoncoop$CBA__XYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)      
    ,"4-7 °C | 0.40" = BKDnoncoop$CBA__XZX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    ,"5-6 °C | 0.40" = BKDnoncoop$CBA__YYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"5-7 °C | 0.40" = BKDnoncoop$CBA__YZX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.25" = BKDnoncoop$CBA__XXK$get_world_EMIffi_ty  
    ,"4-6 °C | 0.25" = BKDnoncoop$CBA__XYK$get_world_EMIffi_ty      
    ,"4-7 °C | 0.25" = BKDnoncoop$CBA__XZK$get_world_EMIffi_ty 

    ,"5-6 °C | 0.25" = BKDnoncoop$CBA__YYK$get_world_EMIffi_ty  
    ,"5-7 °C | 0.25" = BKDnoncoop$CBA__YZK$get_world_EMIffi_ty  
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.25" = BKDnoncoop$CBA__XXK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"4-6 °C | 0.25" = BKDnoncoop$CBA__XYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)      
    ,"4-7 °C | 0.25" = BKDnoncoop$CBA__XZK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
     
    ,"5-6 °C | 0.25" = BKDnoncoop$CBA__YYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"5-7 °C | 0.25" = BKDnoncoop$CBA__YZK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.15" = BKDnoncoop$CBA__XXJ$get_world_EMIffi_ty  
    ,"4-6 °C | 0.15" = BKDnoncoop$CBA__XYJ$get_world_EMIffi_ty      
    ,"4-7 °C | 0.15" = BKDnoncoop$CBA__XZJ$get_world_EMIffi_ty 
    
    ,"5-6 °C | 0.15" = BKDnoncoop$CBA__YYJ$get_world_EMIffi_ty  
    ,"5-7 °C | 0.15" = BKDnoncoop$CBA__YZJ$get_world_EMIffi_ty  
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.15" = BKDnoncoop$CBA__XXJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"4-6 °C | 0.15" = BKDnoncoop$CBA__XYJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)      
    ,"4-7 °C | 0.15" = BKDnoncoop$CBA__XZJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    ,"5-6 °C | 0.15" = BKDnoncoop$CBA__YYJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"5-7 °C | 0.15" = BKDnoncoop$CBA__YZJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.15" = BKDcoop$CBA__XXJ_g0$get_world_EMIffi_ty  
    ,"4-5 °C | 0.25" = BKDcoop$CBA__XXK_g0$get_world_EMIffi_ty      
    ,"4-5 °C | 0.40" = BKDcoop$CBA__XXX_g0$get_world_EMIffi_ty 

    ,"4-6 °C | 0.15" = BKDcoop$CBA__XYJ_g0$get_world_EMIffi_ty  
    ,"4-6 °C | 0.25" = BKDcoop$CBA__XYK_g0$get_world_EMIffi_ty      
    ,"4-6 °C | 0.40" = BKDcoop$CBA__XYX_g0$get_world_EMIffi_ty 
    
    ,"5-6 °C | 0.15" = BKDcoop$CBA__YYJ_g0$get_world_EMIffi_ty  
    ,"5-6 °C | 0.25" = BKDcoop$CBA__YYK_g0$get_world_EMIffi_ty      
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.15" = BKDcoop$CBA__XXJ_g0$get_DAMAGEperc_nty %>% filter(n==myreg)  
    ,"4-5 °C | 0.25" = BKDcoop$CBA__XXK_g0$get_DAMAGEperc_nty %>% filter(n==myreg)      
    ,"4-5 °C | 0.40" = BKDcoop$CBA__XXX_g0$get_DAMAGEperc_nty %>% filter(n==myreg) 
    
    ,"4-6 °C | 0.15" = BKDcoop$CBA__XYJ_g0$get_DAMAGEperc_nty %>% filter(n==myreg)  
    ,"4-6 °C | 0.25" = BKDcoop$CBA__XYK_g0$get_DAMAGEperc_nty %>% filter(n==myreg)      
    ,"4-6 °C | 0.40" = BKDcoop$CBA__XYX_g0$get_DAMAGEperc_nty %>% filter(n==myreg) 
    
    ,"5-6 °C | 0.15" = BKDcoop$CBA__YYJ_g0$get_DAMAGEperc_nty %>% filter(n==myreg)  
    ,"5-6 °C | 0.25" = BKDcoop$CBA__YYK_g0$get_DAMAGEperc_nty %>% filter(n==myreg)     
    
    
  )
  
  ,title  = paste0("Damages (%GDPssp) for ", myreg, " region — CBA coop SSP5")
  ,yLabel = "Damages [%GDPssp]"
  ,legend = "Scenarios"
  ,categories = 3
  ,colors_per_category = 3
...
#============================================================#
####          _______ NONCOOP SSP2 TESTS  ________             ####
#============================================================#
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.40" = BKDssp2_noncoop$CBA__XXX$get_world_EMIffi_ty  
    ,"4-6 °C | 0.40" = BKDssp2_noncoop$CBA__XYX$get_world_EMIffi_ty      
    ,"4-7 °C | 0.40" = BKDssp2_noncoop$CBA__XZX$get_world_EMIffi_ty 
    
    ,"5-6 °C | 0.40" = BKDssp2_noncoop$CBA__YYX$get_world_EMIffi_ty  
    ,"5-7 °C | 0.40" = BKDssp2_noncoop$CBA__YZX$get_world_EMIffi_ty  
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.40" = BKDssp2_noncoop$CBA__XXX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"4-6 °C | 0.40" = BKDssp2_noncoop$CBA__XYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)      
    ,"4-7 °C | 0.40" = BKDssp2_noncoop$CBA__XZX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    ,"5-6 °C | 0.40" = BKDssp2_noncoop$CBA__YYX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"5-7 °C | 0.40" = BKDssp2_noncoop$CBA__YZX$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.25" = BKDssp2_noncoop$CBA__XXK$get_world_EMIffi_ty  
    ,"4-6 °C | 0.25" = BKDssp2_noncoop$CBA__XYK$get_world_EMIffi_ty      
    ,"4-7 °C | 0.25" = BKDssp2_noncoop$CBA__XZK$get_world_EMIffi_ty 
    
    ,"5-6 °C | 0.25" = BKDssp2_noncoop$CBA__YYK$get_world_EMIffi_ty  
    ,"5-7 °C | 0.25" = BKDssp2_noncoop$CBA__YZK$get_world_EMIffi_ty  
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
     ...
     "4-5 °C | 0.25" = BKDssp2_noncoop$CBA__XXK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"4-6 °C | 0.25" = BKDssp2_noncoop$CBA__XYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)      
    ,"4-7 °C | 0.25" = BKDssp2_noncoop$CBA__XZK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    ,"5-6 °C | 0.25" = BKDssp2_noncoop$CBA__YYK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"5-7 °C | 0.25" = BKDssp2_noncoop$CBA__YZK$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "4-5 °C | 0.15"  = BKDssp2_noncoop$CBA__XXJ$get_world_EMIffi_ty  
    ,"4-6 °C | 0.15" = BKDssp2_noncoop$CBA__XYJ$get_world_EMIffi_ty      
    ,"4-7 °C | 0.15" = BKDssp2_noncoop$CBA__XZJ$get_world_EMIffi_ty 
    
    ,"5-6 °C | 0.15" = BKDssp2_noncoop$CBA__YYJ$get_world_EMIffi_ty  
    ,"5-7 °C | 0.15" = BKDssp2_noncoop$CBA__YZJ$get_world_EMIffi_ty  
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "4-5 °C | 0.15"  = BKDssp2_noncoop$CBA__XXJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"4-6 °C | 0.15" = BKDssp2_noncoop$CBA__XYJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)      
    ,"4-7 °C | 0.15" = BKDssp2_noncoop$CBA__XZJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
    
    ,"5-6 °C | 0.15" = BKDssp2_noncoop$CBA__YYJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg)  
    ,"5-7 °C | 0.15" = BKDssp2_noncoop$CBA__YZJ$get_PARAMETER_nty("damfrac_estim_ykali", year_limit = 2300) %>% filter(n==myreg) 
...
#============================================================#
####          _______ COOP SSP2 TESTS  ________             ####
#============================================================#
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "4-5 °C | 0.15"  = BKDssp2_coop$CBA__XXJ_g0$get_world_EMIffi_ty  
    ,"4-5 °C | 0.25" = BKDssp2_coop$CBA__XXK_g0$get_world_EMIffi_ty      
    ,"4-5 °C | 0.40" = BKDssp2_coop$CBA__XXX_g0$get_world_EMIffi_ty 
    
    ,"4-6 °C | 0.15" = BKDssp2_coop$CBA__XYJ_g0$get_world_EMIffi_ty  
    ,"4-6 °C | 0.25" = BKDssp2_coop$CBA__XYK_g0$get_world_EMIffi_ty      
    ,"4-6 °C | 0.40" = BKDssp2_coop$CBA__XYX_g0$get_world_EMIffi_ty 
    
    ,"5-6 °C | 0.15" = BKDssp2_coop$CBA__YYJ_g0$get_world_EMIffi_ty  
    ,"5-6 °C | 0.25" = BKDssp2_coop$CBA__YYK_g0$get_world_EMIffi_ty      
    
  )
  
  ,title  = paste0("World emissions — CBA coop SSP2 - gamma 0")
  ,yLabel = "Emissions FFI [GtCO2]"
  ,legend = "Scenarios"
  ,categories = 1
  ,colors_per_category = 8
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "4-5 °C | 0.15"  = BKDssp2_coop$CBA__XXJ_g0$get_DAMAGEperc_nty %>% filter(n==myreg)  
    ,"4-5 °C | 0.25" = BKDssp2_coop$CBA__XXK_g0$get_DAMAGEperc_nty %>% filter(n==myreg)      
    ,"4-5 °C | 0.40" = BKDssp2_coop$CBA__XXX_g0$get_DAMAGEperc_nty %>% filter(n==myreg) 
    
    ,"4-6 °C | 0.15" = BKDssp2_coop$CBA__XYJ_g0$get_DAMAGEperc_nty %>% filter(n==myreg)  
    ,"4-6 °C | 0.25" = BKDssp2_coop$CBA__XYK_g0$get_DAMAGEperc_nty %>% filter(n==myreg)      
    ,"4-6 °C | 0.40" = BKDssp2_coop$CBA__XYX_g0$get_DAMAGEperc_nty %>% filter(n==myreg) 
    
    ,"5-6 °C | 0.15" = BKDssp2_coop$CBA__YYJ_g0$get_DAMAGEperc_nty %>% filter(n==myreg)  
    ,"5-6 °C | 0.25" = BKDssp2_coop$CBA__YYK_g0$get_DAMAGEperc_nty %>% filter(n==myreg)     
    
    
  )
  
  ,title  = paste0("Damages (%GDPssp) for ", myreg, " region — CBA coop SSP2 - gamma 0")
  ,yLabel = "Damages [%GDPssp]"
  ,legend = "Scenarios"
  ,categories = 3
  ,colors_per_category = 3
...
#============================================================#
####          _______ COOP DISENTGL COMPARED  ________             ####
#============================================================#
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "$4-5 °C | 0.15 | \\gamma = 0$"     = BKDssp2_coop$CBA__XXJ_g0$get_world_EMIffi_ty  
    ,"$4-5 °C | 0.15 | \\gamma = 0.5$"  = BKDssp2_coop$CBA__XXJ_g0x5$get_world_EMIffi_ty      
    ,"$4-5 °C | 0.15 | \\gamma = 1.45$" = BKDssp2_coop$CBA__XXJ_g1x45$get_world_EMIffi_ty 
    ,"$4-5 °C | 0.15 | \\gamma = 2$"    = BKDssp2_coop$CBA__XXJ_g2$get_world_EMIffi_ty  
  
    
  )
  
  ,title  = paste0("World emissions — CBA coop SSP2 — different $\\gamma$")
  ,yLabel = "Emissions FFI [GtCO2]"
  ,legend = "Scenarios"
  ,categories = 1
  ,colors_per_category = 8
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "$4-5 °C | 0.15 | \\gamma = 0$"     = BKDssp2_coop$CBA__XXJ_g0$get_DAMAGEperc_nty %>% filter(n==myreg) 
    ,"$4-5 °C | 0.15 | \\gamma = 0.5$"  = BKDssp2_coop$CBA__XXJ_g0x5$get_DAMAGEperc_nty %>% filter(n==myreg)     
    ,"$4-5 °C | 0.15 | \\gamma = 1.45$" = BKDssp2_coop$CBA__XXJ_g1x45$get_DAMAGEperc_nty %>% filter(n==myreg) 
    ,"$4-5 °C | 0.15 | \\gamma = 2$"    = BKDssp2_coop$CBA__XXJ_g2$get_DAMAGEperc_nty %>% filter(n==myreg) 
    
  )
  
  ,title  = paste0("Damages (%GDPssp) for ", myreg, " region — CBA coop SSP2  — different $\\gamma$")
  ,yLabel = "Damages [%GDPssp]"
  ,legend = "Scenarios"
  ,categories = 3
  ,colors_per_category = 3
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "$4-5 °C | 0.15 | \\gamma = 0$"     = BKDcoop$CBA__XXJ_g0$get_world_EMIffi_ty  
    ,"$4-5 °C | 0.15 | \\gamma = 0.5$"  = BKDcoop$CBA__XXJ_g0x5$get_world_EMIffi_ty      
    ,"$4-5 °C | 0.15 | \\gamma = 1.45$" = BKDcoop$CBA__XXJ_g1x45$get_world_EMIffi_ty 
    ,"$4-5 °C | 0.15 | \\gamma = 2$"    = BKDcoop$CBA__XXJ_g2$get_world_EMIffi_ty  
    
    
  )
  
  ,title  = paste0("World emissions — CBA coop SSP5 — different $\\gamma$")
  ,yLabel = "Emissions FFI [GtCO2]"
  ,legend = "Scenarios"
  ,categories = 1
  ,colors_per_category = 8
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "$4-5 °C | 0.15 | \\gamma = 0$"     = BKDcoop$CBA__XXJ_g0$get_DAMAGEperc_nty %>% filter(n==myreg) 
    ,"$4-5 °C | 0.15 | \\gamma = 0.5$"  = BKDcoop$CBA__XXJ_g0x5$get_DAMAGEperc_nty %>% filter(n==myreg)     
    ,"$4-5 °C | 0.15 | \\gamma = 1.45$" = BKDcoop$CBA__XXJ_g1x45$get_DAMAGEperc_nty %>% filter(n==myreg) 
    ,"$4-5 °C | 0.15 | \\gamma = 2$"    = BKDcoop$CBA__XXJ_g2$get_DAMAGEperc_nty %>% filter(n==myreg) 
    
  )
  
  ,title  = paste0("Damages (%GDPssp) for ", myreg, " region — CBA coop SSP5  — different $\\gamma$")
  ,yLabel = "Damages [%GDPssp]"
  ,legend = "Scenarios"
  ,categories = 3
  ,colors_per_category = 3
...
#============================================================#
####          _______ WORLD LINE CHARTS  ________         ####
#============================================================#


#----  W EMI  -  SSP5 SR -  #Gamma  #coop  -------------------------
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "$COOP \\gamma = 0$"     = BKDcoop$CBA__XXJ_g0$get_world_EMIffi_ty  
    ,"$COOP \\gamma = 0.5$"  = BKDcoop$CBA__XXJ_g0x5$get_world_EMIffi_ty      
    ,"$COOP \\gamma = 1.45$" = BKDcoop$CBA__XXJ_g1x45$get_world_EMIffi_ty 
    ,"$COOP \\gamma = 2$"    = BKDcoop$CBA__XXJ_g2$get_world_EMIffi_ty  
    
    ,"NON COOP" = BKDnoncoop$CBA__XXJ$get_world_EMIffi_ty
    ,"COOP POP" = BKDcooppop$CBA__XXJ_pop$get_world_EMIffi_ty
    
    ,"Historical"  = E_hist_PRIMAP_world_y %>% mutate(t=(year-2010)/5) %>% filter(year >=2000) %>% mutate(unit = "GtCO2/year")
    ,"BAU no-dmg"  = BKDnoncoop$BAU$get_world_EMIffi_ty
    ,"BAU dmg"     = BKD$BAUdam__XXJ$get_world_EMIffi_ty  
    
  )
  ,title  = "World FFI Emissions - SSP5 Burke SR - Damages Discounted between $4-5 °C | 0.15 $"
...
plottigat <- RICEx.plot.lineplot(
  ...
  EXPdata   = list(
    ...
    "$COOP \\gamma = 0$"     = BKDssp2_coop$CBA__XXJ_g0$get_world_EMIffi_ty  
    ,"$COOP \\gamma = 0.5$"  = BKDssp2_coop$CBA__XXJ_g0x5$get_world_EMIffi_ty      
    ,"$COOP \\gamma = 1.45$" = BKDssp2_coop$CBA__XXJ_g1x45$get_world_EMIffi_ty 
    ,"$COOP \\gamma = 2$"    = BKDssp2_coop$CBA__XXJ_g2$get_world_EMIffi_ty  
    
    ,"NON COOP" = BKDssp2_noncoop$CBA__XXJ$get_world_EMIffi_ty
    ,"COOP POP" = BKDssp2_cooppop$CBA__XXJ_pop$get_world_EMIffi_ty
    
    ,"Historical"  = E_hist_PRIMAP_world_y %>% mutate(t=(year-2010)/5) %>% filter(year >=2000) %>% mutate(unit = "GtCO2/year")
    ,"BAU no-dmg"  = BKDssp2_noncoop$BAU$get_world_EMIffi_ty

    
    )
  ,title  = "World FFI Emissions - SSP2 Burke SR - Damages Discounted between $4-5 °C | 0.15 $"
  ,yLabel = "Emissions [GtCO2/year]"
  ,legend = "Scenarios"
  ,categories = 2
  ,colors_per_category = 4
...
#============================================================#
####       _______ REGIONS LINE CHARTS   ________         ####
#============================================================#
...
## -----------------  DAMFRAC nty , BAUdam SSP5 , 4-5-0.15 -------------------


plottigat = ggplot() + 
  
  geom_line(data= BKD$BAUdam__XXJ$get_PARAMETER_nty("damfrac_estim_ykali")
  ...
  ggtitle("Damage fraction - BAUdam - 4-5º C | 0.15 " ) + 
  xlab("Year") +
  ylab("Damages [%GDPssp]")  ; plottigat



## -----------------  DAMFRAC nty , BAUdam SSP5 , 4-5-0.25 -------------------


plottigat = ggplot() + 
  
  geom_line(data= BKD$BAUdam__XXK$get_PARAMETER_nty("damfrac_estim_ykali")
            ,aes(x=year, y=value, group=n, color = n)
            ,size = 1)  + 
  ...
  ggtitle("Damage fraction - BAUdam - 4-5º C | 0.25 " ) + 
  xlab("Year") +
  ylab("Damages [%GDPssp]")  ; plottigat
...
## -----------------  DAMFRAC nty , BAUdam SSP2 , 4-5-0.15 -------------------
