...
BurkeCap = list()
BurkeCap = experiments_load_as_list(BurkeCap,"BurkeCap")



# shortcuts
BKC_opt = BurkeCap$v1x00$OPTIM$ed57
BKC_sim = BurkeCap$v1x00$SIMUL$ed57
...
#=============================================================================#
####          ____________  WORLD LINE CHARTS  ____________                ####
#=============================================================================#
